...
class FitxaGrau(BasePacket):
    ...
    def __init__(self, context):
        ...
        self.URL_schema = 'http://www.upc.edu/grau/fitxa_grau.php?codi=%(codi_grau)s&lang=%(lang)s&sense_titol&contingut_upc=true&genweb=true&version=6&url=%(url)s'
...
class PlaEstudisGrau(BasePacket):
    ...
    def __init__(self, context):
        ...
        self.URL_schema = 'http://www.upc.edu/grau/fitxa_grau.php?codi=%(codi_grau)s&lang=%(lang)s&pla_estudis&sense_titol&contingut_upc=true&genweb=true&version=6&url=%(url)s'
        self.fields = [_(u'codi_grau')]
        self.default = dict([(field, '') for field in self.fields])
        self.mapui = dict(codi=u'codi_grau')
...
class FitxaMaster(BasePacket):
    ...
    def __init__(self, context):
        ...
        self.URL_schema = 'http://www.upc.edu/master/fitxa_master.php?id_estudi=%(codi_master)s&lang=%(lang)s&sense_titol&contingut_upc=true&genweb=true&version=6&url=%(url)s'
...
class PlaEstudisMaster(BasePacket):
    ...
    def __init__(self, context):
        ...
        self.URL_schema = 'http://www.upc.edu/master/fitxa_master.php?id_estudi=%(codi_pla_master)s&lang=%(lang)s&pla_estudis&sense_titol&contingut_upc=true&genweb=true&version=6&url=%(url)s'
